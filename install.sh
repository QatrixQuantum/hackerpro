...
echo -e "${RED}                  ~ Tools for Hacking by QatrixQuantum ${NC}"
echo ""
echo -e "${YELLOW} http://heimanbotz.tk | https://facebook.com/heiman.picture.3 | https://github.com/QatrixQuantum ${NC} "
echo ""
echo "---------------------------------------------------------------------------------------"
echo ""
